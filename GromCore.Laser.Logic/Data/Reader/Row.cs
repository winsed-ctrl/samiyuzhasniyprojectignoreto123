...
namespace GromCore.Laser.Logic.Data.Reader
{
    public class Row
    {
        ...
        public int GetArraySizeAt(int index)
        {
            return index != -1 ? _table.GetArraySizeAt(this, index) : 0;
        }
        ...
        {
            return _table.GetValueAt(index, RowStart);
        }

        public string GetValueAt(int index,int offset)
        {
            return _table.GetValueAt(index, RowStart+offset);
        }
