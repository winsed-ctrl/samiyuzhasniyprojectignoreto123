...
namespace GromCore.Laser.Logic.Data
{
    public class CharacterData : LogicData
    {
        ...
        public int IsBoss(int a1 = 0)
        {
            if (Type == "Npc_Boss" || Type == "Npc_Boss_TownCrush") return 1;
            return 0;
        }
        ...
        public bool IsMinionInvasion()
        {
            return Type == "Minion_Invasion";
        }
        ...
        public int ChargeUltiFromDamage { get; set; }
    }
}
