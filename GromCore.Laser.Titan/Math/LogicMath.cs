...
namespace GromCore.Laser.Titan.Math
{
    public static unsafe class LogicMath
    {
        ...
        public static int GetAngle(int x, int y)
        {
            ...
            //angle -= 90;
            //Debugger.Print(angle.ToString());
            //return NormalizeAngle360((int)angle);
        }
        ...
        public static int GetAngleBetween(int a1, int a2)
        {
            ...
            result = (a1 - a2) % 360 + ((a1 - a2) % 360 < 0 ? 360 : 0);
            if (result > 179)
                result -= 360;
            if (result < 0)
                return -result;
        ...
        public static int GetRotatedX(int x, int y, int angle)
        {
            ...
            v3 = (angle + 90) % 360 + ((angle + 90) % 360 < 0 ? 0x168 : 0);
            if (v3 > 179)
            {
                v5 = v3 - 180;
                if (v3 - 180 > 90)
            ...
            v6 = v4 * x;
            v7 = angle % 360 + (angle % 360 < 0 ? 0x168 : 0);
            if (v7 > 179)
            {
                v9 = v7 - 180;
                if (v7 - 180 > 90)
        ...
        public static int GetRotatedY(int x, int y, int angle)
        {
            ...
            v3 = angle % 360 + (angle % 360 < 0 ? 0x168 : 0);
            if (v3 > 179)
            {
                v5 = v3 - 180;
                if (v3 - 180 > 90)
            ...
            v6 = v4 * x;
            v7 = (angle + 90) % 360 + ((angle + 90) % 360 < 0 ? 0x168 : 0);
            if (v7 > 179)
            {
                v9 = v7 - 180;
                if (v7 - 180 > 90)
